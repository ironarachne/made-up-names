 ...
 */
export class BaseNameGenerator implements NameGenerator {
  name: string;
  patterns: string[];
  combinations: Combination[];
  random: RNG;
 ...
 */
export function getCultureNamePatternSet(
  name: string,
 ...
 */
export function getMagicItemNameGenerator(
  rng: RNG = new RNG(Date.now()),
): NameGenerator {
  const patterns = [
    "cvpv",
    "vc+vc",
 ...
 */
export function getModelNumberNameGenerator(
  rng: RNG = new RNG(Date.now()),
): NameGenerator {
 ...
 */
export function getNameGeneratorForPatternSet(
  name: string,
 ...
 */
export function getPlanetNameGenerator(
  rng: RNG = new RNG(Date.now()),
): NameGenerator {
  const patterns = [
    "avnvs",
 ...
 */
export function getClassicRaceNamePatternSet(
  name: string,
): NameGeneratorPatternSet {
  switch (name) {
    case "dragonborn":
 ...
 */
export function getStarNameGenerator(
  rng: RNG = new RNG(Date.now()),
): NameGenerator {
  const patterns = [
    "pvn",
 ...
 */
export function getStarNationNameGenerator(
  rng: RNG = new RNG(Date.now()),
): NameGenerator {
  const patterns = [
    "pvn",
